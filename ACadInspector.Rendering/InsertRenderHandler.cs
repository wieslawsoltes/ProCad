...
public sealed class InsertRenderHandler : IRenderEntityHandler
{
    ...
    private static CadRenderSceneSettings WithSupportPaths(CadRenderSceneSettings settings, string? resolvedPath)
    {
        ...
        return new CadRenderSceneSettings
        {
            ...
            ViewportBrightness = settings.ViewportBrightness,
            ViewportContrast = settings.ViewportContrast,
            ...
            EnableDashPatternRendering = settings.EnableDashPatternRendering,
            EnableColorRendering = settings.EnableColorRendering,
            ...
            DynamicBlockVisibilityStateName = settings.DynamicBlockVisibilityStateName,
            DynamicBlockOverrideProvider = settings.DynamicBlockOverrideProvider,
            ...
            PlotStyleTable = settings.PlotStyleTable
        };
    }
