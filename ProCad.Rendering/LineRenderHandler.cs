...
public sealed class LineRenderHandler : IRenderEntityHandler
{
    ...
    public void Append(Entity entity, Transform transform, RenderBuildContext context)
    {
        ...
        var lineTransform = RenderTransformUtils.CombineWithNormal(transform, line.Normal);
        ...
        var start3 = RenderTransformUtils.Apply3D(lineTransform, line.StartPoint);
        var end3 = RenderTransformUtils.Apply3D(lineTransform, line.EndPoint);
