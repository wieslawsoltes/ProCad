...
public sealed class ChamferCadCommand : ICadCommandHandler
{
    ...
    public ValueTask<CadCommandResult> ExecuteAsync(CadCommandContext context)
    {
        ...
        if (!CadFilletChamferGeometry.TryComputeChamfer(
                firstLine,
                secondLine,
                firstDistance,
                secondDistance,
        ...
        var forwardOperations = new CadOperation[]
        {
            ...
            CadOperationPayloadCodec.CreateLine(chamferId, geometry.ChamferStart, geometry.ChamferEnd).WithSourceProperties(firstLine)
        };

        var inverseOperations = new CadOperation[]
        {
            CadOperationPayloadCodec.DeleteLine(chamferId, geometry.ChamferStart, geometry.ChamferEnd),
        ...
        out string? error)
    {
        ...
        {
            error = "CHAMFER currently supports only LINE targets.";
            return false;
        }
