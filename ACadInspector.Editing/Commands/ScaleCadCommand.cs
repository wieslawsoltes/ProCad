...
public sealed class ScaleCadCommand : ICadCommandHandler
{
    public string Name => "SCALE";
    public IReadOnlyList<string> Aliases => ["SC"];
    ...
    public ValueTask<CadCommandResult> ExecuteAsync(CadCommandContext context)
    {
        ...
        if (!CadCommandParsing.TryParseScaleArguments(context.Arguments, out var factor, out var center, out var consumed, out var parseError))
        {
        ...
        foreach (var target in targets)
        {
            ...
            switch (target)
            {
                case Line line:
                {
                    ...
                    var toStart = CadGeometryTransform.Scale(fromStart, center, factor);
                    var toEnd = CadGeometryTransform.Scale(fromEnd, center, factor);
                ...
                case Arc arc:
                {
                    ...
                    var toCenter = CadGeometryTransform.Scale(fromCenter, center, factor);
                    var toRadius = arc.Radius * factor;
                    var toStartAngle = arc.StartAngle;
                    var toEndAngle = arc.EndAngle;
                ...
                case Circle circle:
                {
                    ...
                    var toCenter = CadGeometryTransform.Scale(fromCenter, center, factor);
                    var toRadius = circle.Radius * factor;
                ...
                case LwPolyline polyline:
                {
                    ...
                    var toVertices = CadGeometryTransform.ScaleVertices(fromVertices, center, factor);
                ...
                case Point point:
                {
                    ...
                    var toLocation = CadGeometryTransform.Scale(fromLocation, center, factor);
                ...
                case XLine xline:
                {
                    ...
                    var toFirstPoint = CadGeometryTransform.Scale(fromFirstPoint, center, factor);
                ...
                case Ray ray:
                {
                    ...
                    var toStartPoint = CadGeometryTransform.Scale(fromStartPoint, center, factor);
                    var toDirection = fromDirection;
                ...
                case TextEntity text:
                {
                    ...
                    var toInsertPoint = CadGeometryTransform.Scale(fromInsertPoint, center, factor);
                    var toAlignmentPoint = CadGeometryTransform.Scale(fromAlignmentPoint, center, factor);
                    var toHeight = fromHeight * factor;
                ...
                case MText mtext:
                {
                    ...
                    var toHeight = fromHeight * factor;
                    var toRectangleWidth = fromRectangleWidth * factor;
                ...
                case Ellipse ellipse:
                {
                    ...
                    var toCenter = CadGeometryTransform.Scale(fromCenter, center, factor);
                    var toMajorAxisEndPoint = CadGeometryTransform.ScaleVector(fromMajorAxisEndPoint, factor);
                ...
                case Spline spline:
                {
                    ...
                    var toFitPoints = fromFitPoints
                        .Select(point => CadGeometryTransform.Scale(point, center, factor))
                        .ToArray();
                    ...
                    var toStartTangent = CadGeometryTransform.ScaleVector(fromStartTangent, factor);
                    var toEndTangent = CadGeometryTransform.ScaleVector(fromEndTangent, factor);
                    var toNormal = fromNormal;
                ...
                case Hatch hatch:
                {
                    ...
                    {
                        return ValueTask.FromResult(CadCommandResult.Fail($"SCALE could not transform HATCH: {loopError}"));
                    }

                    var toLoops = CadHatchGeometry.ScaleLoops(fromLoops, center, factor);
                ...
                case Insert insert:
                {
                    ...
                    {
                        return ValueTask.FromResult(CadCommandResult.Fail("SCALE cannot transform INSERT without a block reference."));
                    }
                    ...
                    var toInsertPoint = CadGeometryTransform.Scale(fromInsertPoint, center, factor);
                    var toXScale = fromXScale * factor;
                    var toYScale = fromYScale * factor;
                    var toZScale = fromZScale * factor;
                    var toRotation = fromRotation;
                    var toNormal = fromNormal;
                ...
                default:
                    return ValueTask.FromResult(CadCommandResult.Fail($"SCALE does not support entity type '{target.GetType().Name}' yet."));
            }
        }
        ...
        return ValueTask.FromResult(CadCommandResult.Ok($"Scaled {targets.Count} entity(s).", forward));
    }
}
