...
public sealed class CadInspectorSelectionSyncMatrixTests
{
    [Fact]
    public async Task SelectionAndSessionRevision_KeepTreePropertiesDxfPanelsInSync()
    {
        ...
        var commandRegistry = new ACadInspector.Editing.Commands.CadCommandRegistry();
        commandRegistry.Register(new ACadInspector.Editing.Commands.MoveCadCommand());
        commandRegistry.Register(new ACadInspector.Editing.Commands.UndoCadCommand());
        commandRegistry.Register(new ACadInspector.Editing.Commands.RedoCadCommand());
